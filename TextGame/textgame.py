...
class Enemy:
    ...
    def randomEnemy(
        self, number
    ):  # Takes a number between 1-100, set enemy depending on user luck
...
class RPGame:
        ...
        while self.isAlive == True:
            ...
            if userChoice == 1:  # Explore
                ...
                if playerHP >= 75:
                    ...
                    print(
                        Color.DARKCYAN + "Need healing, I might not make it" + Color.END
                    )
                else:
    ...
    def combat(self, player):
        ...
        while (
            combatHP > 0 or self.isAlive == True or enemyHP > 0
        ):  # While player is still in the game
...
class EightBall:
    def runGame(self):
        ...
        while userChoice != 0:
            ...
            userChoice = int(
                input("Be illuminated by the EightBall\n1. Roll ball\n0. Exit")
            )
