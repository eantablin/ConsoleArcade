...
class HangMan:
    ...
    def gameOn(self):
        ...
        wordLetters = set(
            word
        )  # Used to keep track of all the letters in the chosen word
        ...
        while len(wordLetters) > 0 and chances > 0:
            cls()
            print(
                hangmanascii.printHangmanASCII(chances)
            )  # Prints the corresponding Hangman acsii art
            print("")
            print(
                color.Color.BLUE
                + "You have "
                ...
                " ".join(usedLetters) + color.Color.END,
            )  # " ".join(['a', 'b', 'cd']) --> 'a b cd'
            listLetters = [
                letter if letter in usedLetters else "-" for letter in word
            ]  # Current word ie (W - O R D)
            print(
                color.Color.CYAN + "Current word: ",
                " ".join(listLetters) + color.Color.END,
            )
            ...
            if userLetter in alphabet - usedLetters:
                ...
                if userLetter in wordLetters:
                    ...
                    chances -= (
                        1  # If user guesses incorrectly, they lose a guess chance
                    )
        ...
        if chances == 0:
            print(
                color.Color.RED + hangmanascii.hangmanL + color.Color.END
