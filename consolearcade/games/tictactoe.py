...
class TicTacToe:
    ...
    def printBoard(self):  # Will be used to print a 3 * 3 TicTacToe board
        ...
        ]:  # Break up into groups of 3 spaces
            print("| " + " | ".join(row) + " |")

    def clearBoard(
        self,
    ):  # Used to clear the game board and reset the currentWinner after a game
    ...
    def printBoardNums():
        ...
        ]  # Give indices of what number is in what row
    ...
    def winner(self, square, letter):
        ...
        if all(
            [spot == letter for spot in column]
        ):  # Checks for three of the same letter in a column
            return True
        ...
        if square % 2 == 0:
            ...
            if all(
                [spot == letter for spot in diagonal1]
            ):  # Checks for three of the same letter in diagonal1
                return True
            diagonal2 = [self.board[i] for i in [2, 4, 6]]
            if all(
                [spot == letter for spot in diagonal2]
            ):  # Checks for three of the same letter in diagonal2
                return True
    ...
    def runGame(self):
        ...
        while userChoice != 0:
            ...
            try:
                ...
                print(
                    color.Color.RED
                    + "HINT: The only valid inputs are 1 and 0!"
                    + color.Color.END
                )
                time.sleep(1.5)
            cls()
...
class ComputerPlayer(Player):
    ...
    def getMove(self, game):
        square = choice(
            TicTacToe.availableMoves(game)
        )  # Selects a random available space for ComputerPlayer
        return square
